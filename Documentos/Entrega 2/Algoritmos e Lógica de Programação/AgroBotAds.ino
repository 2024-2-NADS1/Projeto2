...
#define WIFI_SSID "nome do wi-fi"
#define WIFI_PASS "senha wi-fi"
#define HOSTNAME "aithinker"
...
void setup()
{
  ...
  // Conecta ao Wi-Fi
    ...
    Serial.println("Servidor de Coleta de Imagens OK");
...
void loop()
{
    String logMessage = "Monitor serial ativo!";
    Serial.println(logMessage);
    serialLogs += logMessage + "\n";

    // Limite o tamanho do buffer para evitar estouro de memória
    if (serialLogs.length() > 2000) {
        serialLogs = serialLogs.substring(serialLogs.length() - 2000);
    }
